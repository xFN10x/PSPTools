...
public class UmdIsoFile extends SeekableInputStream {
    ...
    public UmdIsoFile(UmdIsoReader reader, int startSector, long lengthInBytes, Date timestamp, String name)
            throws IOException {
        startSectorNumber = startSector;
        currentSectorNumber = startSectorNumber;
        currentOffset = 0;

        // Some ISO directory entries indicate a file length past the size of the
        // complete ISO.
    ...
    public int read() throws IOException {
        ...
        // and then decided that streams would have a read() function returning a value
        // [0..255], and -1 for EOF
